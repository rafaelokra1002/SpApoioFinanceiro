...
export const DOCUMENT_TYPES: Record<string, DocumentType[]> = {
  CARTEIRA_ASSINADA: [
    { key: 'RG ou CNH (frente)', label: 'RG ou CNH (Frente)', description: 'Foto ou PDF da frente do documento', icon: '🪪' },
    { key: 'RG ou CNH (verso)', label: 'RG ou CNH (Verso)', description: 'Foto ou PDF do verso do documento', icon: '🪪' },
